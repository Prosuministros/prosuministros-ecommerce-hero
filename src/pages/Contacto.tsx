          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="flex justify-center mt-2">
                <a href="https://www.linkedin.com/company/prosuministros-de-colombia/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-[#00C8CF] hover:text-white text-3xl">
                  {/* Icono de LinkedIn */}
